    ...
    <main className="min-h-screen bg-[#07162f] selection:bg-[#dfb755] selection:text-[#07162f]">
      ...
      <section className="relative pt-40 pb-20 px-4 md:px-6 container text-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl font-serif font-bold text-white mb-6">
            ...
            <span className="text-zinc-500">Magnivida.</span>
          </h1>
          <p className="text-xl text-zinc-400 leading-relaxed">
            We are always looking for disciplined, skilled, and ambitious
            individuals. Join a team that values integrity and timely payments.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-24 container px-4 md:px-6 max-w-5xl mx-auto">
        <h2 className="text-3xl font-serif text-white mb-12 flex items-center gap-3">
          <Briefcase className="text-[#dfb755]" /> Careers at Magnivida
        </h2>
        ...
        {OPEN_POSITIONS.length === 0 ? (
          ...
          <div className="text-center p-12 rounded-2xl bg-white/5 border border-white/10">
            ...
            <p className="text-zinc-400 max-w-xl mx-auto mb-8">
              We don’t have any active job openings at the moment. However, we
              are always interested in meeting skilled and disciplined
              professionals. Submit your resume and we’ll reach out when a
              suitable role opens.
            </p>
              ...
              >
                <div className="flex flex-col md:flex-row gap-6 md:items-start justify-between">
                  ...
                  <div className="space-y-4 flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {job.requirements.map((req, idx) => (
                        <span
                          key={idx}
                          className="text-xs text-zinc-500 bg-black/40 px-2 py-1 rounded border border-white/5"
                        >
                          {req}
                        </span>
                      ))}
                  ...
                  <div className="md:text-right flex flex-col items-start md:items-end justify-between gap-4">
                    <Button
                      onClick={() =>
                        setSelectedJob({ title: job.role, id: job.id })
                      }
                      variant="outline"
